...
let grammar: Grammar = {
    tokens: ['val', 'var', 'id', 'type_base', ':', ';', '.', ',', 'class', 'function', '!', '{', '}', '(', ')', 'if', 'else', 'while', 'do', 'for', '=', '[', ']', 'new', 'const_val', 'break', 'continue', 'get', 'set', 'return', 'extend', 'switch', 'case', 'default', 'operator'],
    association: [
    ...
    BNF: [
        ...
        { "extend_or_empty:": {} },
        { "extend_or_empty:extend : base_types": {} },
        { "base_types:base_types , id": {} },
        { "base_types:id": {} },
        ...
        { "arguments:object": {} },
        { "type:type_base array_def": {} },//数组类型
        { "array_def:[ ] array_def": {} },
        { "array_def:": {} },
        { "type:function ( parameters_or_empty ) : type": {} },//函数类型
