 ...
 */
function nodeRecursion(scope: Scope, node: ASTNode): { type: TypeUsed, hasRet: boolean, changeAble?: boolean } {
    if (node["def"] != undefined) {
        ...
        throw `检查左子节点是否允许修改 val和有set,分别从load和access节点拿到数据`;
