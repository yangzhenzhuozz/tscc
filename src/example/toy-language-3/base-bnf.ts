...
let grammar: Grammar = {
    ...
    BNF: [
        ...
        { "declare_in__class:var id : type = object_immediate": {} },//program和class的声明语句也不能包含可执行代码，所以只能使用一个立即数、数组、一个new出来的对象或者是lambda表达式
        { "declare_in__class:var id = object_immediate": {} },
        { "declare_in__class:var id : type": {} },
        { "declare_in__class:function_definition": {} },
        { "declare_in_program:var id : type = object_immediate": {} },//program中的声明必须初始化
        { "declare_in_program:var id = object_immediate": {} },
        ...
        { "object:this": {} },
        { "object:id": {} },
        { "object:object_immediate": {} },
        { "object_immediate:immediate_val": {} },
        { "object_immediate:new basic_type ( arguments )": {} },
        { "object_immediate:new basic_type array_init_list": {} },
        { "object_immediate:( lambda_arguments ) => { statements }": {} },//lambda
        { "object_immediate:immediateTuple": {} },//可以在program空间中使用的tuple
        { "immediateTuple:[ object_immediate , immediateTuple_list ]": {} },//目前tuple只支持使用object_immediate初始化
        { "immediateTuple_list:immediateTuple_list , object_immediate": {} },
        { "immediateTuple_list:object_immediate": {} },
